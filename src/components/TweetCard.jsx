...
const TweetCard = ({ username = "レスバ太郎", handle = "@resbatarou", text, profileImage }) => {
  return (
    <div className="bg-gray-900 border border-gray-700 rounded-xl p-3 sm:p-4 max-w-2xl mx-auto">
      <div className="flex space-x-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center space-x-2">
            <h3 className="text-white font-bold truncate text-sm sm:text-base">{username}</h3>
            <span className="text-gray-400 text-xs sm:text-sm truncate">{handle}</span>
            <span className="text-gray-400 text-xs sm:text-sm">·</span>
            <span className="text-gray-400 text-xs sm:text-sm">今</span>
          </div>
          ...
          {/* Twitter風アクションボタン */}
          <div className="flex items-center mt-3 space-x-4 sm:space-x-8 text-gray-400">
            <button className="flex items-center space-x-1 sm:space-x-2 hover:text-blue-400 transition-colors">
              ...
              <span className="text-xs sm:text-sm">返信</span>
            </button>
            ...
            <button className="flex items-center space-x-1 sm:space-x-2 hover:text-green-400 transition-colors">
              ...
              <span className="text-xs sm:text-sm hidden sm:inline">リツイート</span>
              <span className="text-xs sm:text-sm sm:hidden">RT</span>
            </button>
